...
export function WrongDomainState({ onRetry }: Props) {
  return (
    ...
    >
      ...
      >
        <circle cx="16" cy="16" r="13.25" stroke="#ccc" strokeWidth="1.5" />
        <line x1="16" y1="2.75" x2="16" y2="29.25" stroke="#ccc" strokeWidth="1.5" />
        <path d="M2.75 16 Q8 10.5 16 10.5 Q24 10.5 29.25 16" stroke="#ccc" strokeWidth="1.5" fill="none" />
        <path d="M2.75 16 Q8 21.5 16 21.5 Q24 21.5 29.25 16" stroke="#ccc" strokeWidth="1.5" fill="none" />
